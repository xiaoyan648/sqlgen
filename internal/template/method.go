...
func ({{.S}} {{.QueryStructName}}Do) Not(conds ...sqlgen.Condition) {{.ReturnObject}} {
	return {{.S}}.withDO({{.S}}.DO.Not(conds...))
}

func ({{.S}} {{.QueryStructName}}Do) Or(conds ...sqlgen.Condition) {{.ReturnObject}} {
...
func ({{.S}} {{.QueryStructName}}Do) Where(conds ...sqlgen.Condition) {{.ReturnObject}} {
...
func ({{.S}} {{.QueryStructName}}Do) Having(conds ...sqlgen.Condition) {{.ReturnObject}} {
...
func ({{.S}} {{.QueryStructName}}Do) Scopes(funcs ...func(sqlgen.Dao) sqlgen.Dao) {{.ReturnObject}} {
...
func ({{.S}} {{.QueryStructName}}Do) FindInBatch(batchSize int, fc func(tx sqlgen.Dao, batch int) error) (results []*{{.StructInfo.Package}}.{{.StructInfo.Type}}, err error) {
	buf := make([]*{{.StructInfo.Package}}.{{.StructInfo.Type}}, 0, batchSize)
	err = {{.S}}.DO.FindInBatches(&buf, batchSize, func(tx sqlgen.Dao, batch int) error {
...
func ({{.S}} {{.QueryStructName}}Do) FindInBatches(result *[]*{{.StructInfo.Package}}.{{.StructInfo.Type}}, batchSize int, fc func(tx sqlgen.Dao, batch int) error) error {
...
func ({{.S}} {{.QueryStructName}}Do) Delete(models ...*{{.StructInfo.Package}}.{{.StructInfo.Type}}) (result sqlgen.ResultInfo, err error) {
	return {{.S}}.DO.Delete(models)
}

func ({{.S}} *{{.QueryStructName}}Do) withDO(do sqlgen.Dao) (*{{.QueryStructName}}Do) {
	{{.S}}.DO = *do.(*sqlgen.DO)
	return {{.S}}
}
...
func Test_{{.QueryStructName}}Query(t *testing.T) {
	...
	_, err = _do.Where(primaryKey.IsNotNull()).FindInBatch(10, func(tx sqlgen.Dao, batch int) error { return nil })
	if err != nil {
		t.Error("FindInBatch() on table <{{.TableName}}> fail:", err)
	}

	err = _do.Where(primaryKey.IsNotNull()).FindInBatches(&[]*{{.StructInfo.Package}}.{{.ModelStructName}}{}, 10, func(tx sqlgen.Dao, batch int) error { return nil })
	if err != nil {
	...
	_, err = _do.Scopes(func(dao sqlgen.Dao) sqlgen.Dao { return dao.Where(primaryKey.IsNotNull()) }).Find()
	if err != nil {
